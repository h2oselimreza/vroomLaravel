            ...
            <div id="my-div" class="my-div">
                ...
                <div id="" class="content-div">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" align="center" width="726">
                        ...
                        <tr>
                            <td align="center" class="body-heading2">Statement of Vehicle and Vendor Expense</td>
                        </tr>
                        <tr>
                        ...
                        foreach ($data['expenseDetails'] as $expenseDetail) {
                            if ($expenseDetail->vehicle != $vehicle) {
                               ...
                               $vehicleOtherInfo=$expenseDetail->vehicle_type_name." ".$expenseDetail->brand_name." ".$expenseDetail->brand_model_name;
                                ...
                                if ($inTotalFlag) {
                                    echo "<tr>";
                                    echo "<td class='right-border' align='right'><b>In Total</b></td>";
                                ...
                                echo "<tr>";
                                echo "<td class='right-border top-border vehicle-reg' align='center'><b>" . $registrationNo . "</b><small><i>(".$vehicleOtherInfo.")</i></small><br>".$vehiclePurchaseInfo. "</td>";
                            ...
                            if ($vehicle == $expenseDetail->vehicle && $expenseDetail->vendor != $vendor) {
                                echo "<tr>";
                                echo "<td class='right-border' align='left'>" . $expenseDetail->vendor_title . "</td>";
                                echo "<td class='right-border' align='right'>" . $expenseDetail->total_expense . "</td>";
                                echo "</tr>";
