            ...
            <div id="my-div" class="my-div">
                ...
                <div id="" class="content-div">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" align="center" width="726">
                        ...
                        <tr>
                            <td align="center" class="body-heading2">Statement of Vendor and Head Wise Expense</td>
                        </tr>
                        <tr>
                    ...
                    <table class="description" cellpadding="0" cellspacing="0" width="726">
                        ...
                        foreach ($data['expenseDetails'] as $expenseDetail) {
                            if ($expenseDetail->vendor != $vendor) {
                                ...
                                echo "<tr>";
                                echo "<td class='right-border top-border vehicle-reg' align='center' colspan='4'><b>" . $vendorTitle . "</b></td>";
                            ...
                            if ($vendor == $expenseDetail->vendor && $expenseDetail->cost_category != $expenseCategory) {
                                if ($subTotalFlag) {
                                    echo "<tr>";
                                    echo "<td class='right-border' align='right' colspan='4'><b>Sub Total</b></td>";
                                    echo "<td class='right-border' align='right'><b><u>" . number_format($subTotal, 2) . "</u></b></td>";
                            ...
                            if ($vendor == $expenseDetail->vendor && $expenseCategory == $expenseDetail->cost_category && $expenseDetail->expense_head != $expenseHead) {
                                echo "<tr>";
