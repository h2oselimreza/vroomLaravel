...
<div class="block-header">
    ...
    <div class="breadcrumb breadcrumb-bg-blue-grey">
        ...
        <li><a href="/client/Report/expenseReport"> Experience Report</a></li>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-6 col-xs-12">
                        ...
                        <div class="table-custom-responsive">
                            ...
                            <form target="_blank" action="{{ route('client.report.expenseReportDetails') }}" method="POST" id="formId">
                                @csrf
                                ...
                                <div class="modal-dialog modal-sm" role="document">
                                    <div class="modal-content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <div class="demo-radio-button" >
                                                        ...
                                                        <input name="groupByRadio" type="radio" id="vendorRadio" class="with-gap radio-col-brown">
                                                        <label class="form-label" for="vendorRadio"> Vendor </label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn bg-blue btn-primary waves-effect" onclick="showReport()">Show Report</button>
                                            <button type="button" class="btn bg-blue btn-danger waves-effect" data-dismiss="modal">Close</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function submitForm() {
        ...
        if (vehicleIdArr.length === 0 && costHeadArr.length === 0 && vendorArr.length === 0) {
            sweetAlert('Please select at least one vehicle or one expense head or one vendor...!');
            return false;
        }
