        ...
        <div class="full-page" >
            <div id="my-div" class="my-div">
                <style>
                    ...
                    .vechile-td{background-color: #f7f5f5}
                </style>
                ...
                <div id="" class="content-div">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" align="center" width="726">
                        ...
                        <tr>
                            <td align="center" class="body-heading2">Statement of Vehicle, Vendor and Head Wise Expense</td>
                        </tr>
                        <tr>
                    ...
                    <table class="description" cellpadding="0" cellspacing="0" width="726">
                        ...
                        foreach ($data['expenseDetails'] as $expenseDetail) {
                            if ($expenseDetail->vendor != $vendor) {
                                $vendorTitle = $expenseDetail->vendor_title;
                                ...
                                echo "<tr>";
                                echo "<td class='right-border top-border vehicle-reg vechile-td' align='center' colspan='5'><b>" . $vendorTitle . "</b></td>";
                            ...
                            if ($vendor == $expenseDetail->vendor && $expenseDetail->vehicle != $vehicle) {
                               ...
                               $vehicleOtherInfo=$expenseDetail->vehicle_type_name." ".$expenseDetail->brand_name." ".$expenseDetail->brand_model_name;
                                ...
                                echo "<tr>";
                                echo "<td class='right-border top-border vehicle-reg' align='center' colspan='4'><b>" . $registrationNo . "</b><small><i>(".$vehicleOtherInfo.")</i></small><br>".$vehiclePurchaseInfo. "</td>";
                                echo "<td class='top-border right-border' align='right'></td>";
                                echo "</tr>";
                            ...
                            if ($vehicle == $expenseDetail->vehicle && $vendor == $expenseDetail->vendor && $expenseDetail->cost_category != $expenseCategory) {
                                if ($subTotalFlag) {
                                    echo "<tr>";
                                    echo "<td class='right-border' align='right' colspan='4'><b>Sub Total</b></td>";
                                    echo "<td class='right-border' align='right'><b><u>" . number_format($subTotal, 2) . "</u></b></td>";
                            ...
                            if ($vehicle == $expenseDetail->vehicle && $vendor == $expenseDetail->vendor && $expenseCategory == $expenseDetail->cost_category && $expenseDetail->expense_head != $expenseHead) {
                                echo "<tr>";
                    ...
                    <table class="description" cellpadding="0" cellspacing="0" width="726">
                        <tr>
                            <th class="bottom-border right-border" width="590"><b>Vendor</b></th>
                            <th class="bottom-border right-border" width="136"><b>Expense SubTotal (BDT)</b></th>
                        </tr>
                        <?php
                        foreach ($data['vendorDetails'] ?? [] as $vendorDetail) {
                            echo "<tr>";
                            echo "<td class='bottom-border right-border'>$vendorDetail->vendor_title</td>";
                            echo "<td class='bottom-border right-border' align='right'>" . number_format($vendorDetail->total_expense, 2) . "</td>";
                            echo "</tr>";
                        }
                        echo "<tr>";
                    ...
                    <div class="footer">
                        <br><?php echo config('constants.REPORT_FOOTER_CREDIT') ?>
                    </div>
                </div>
                <br>
            </div>  
