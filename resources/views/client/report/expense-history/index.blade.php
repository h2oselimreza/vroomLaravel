...
<div class="block-header">
    <h2>EXPENSE HISTORY</h2><br>
    <div class="breadcrumb breadcrumb-bg-blue-grey">
        <li><a href="/client/Home"> Home</a></li>
        <li><a href="#"> Report</a></li>
        <li><a href="/client/Report/expenseHistory"> Expense History</a></li>
    </div>
</div>
<div class="row clearfix">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="body">
                <div class="row">
                    <form action="{{ route('client.report.expense-history') }}" method="post">
                        @csrf
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group form-float" >
                                <div class="form-line">
                                    <input type="date" value="<?php echo $fromDate ?>" class="form-control" name="fromDate" id="fromDate">
                                </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group form-float" >
                                <div class="form-line">
                                    <input type="date" value="<?php echo $toDate ?>" class="form-control" name="toDate" id="toDate" >
                                </div>
...
<script>
    ...
    function loadData(noExpenseflag) {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ route('client.report.getExpenseHistoryData') }}",
            data: {
            ...
            success: function (result) {
                ...
                // Laravel already returns JSON, no need parseJSON (safe fallback kept)
