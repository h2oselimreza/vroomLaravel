            ...
            <div id="my-div" class="my-div">
                ...
                <div id="" class="content-div">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" align="center" width="726">
                        <tr>
                            <td align="center" class="body-heading2">Current Stock Report</td>
                        </tr>
                    </table>
                    ...
                    <table class="description" cellpadding="0" cellspacing="0" width="726">
                        ...
                        foreach ($variants as $variant) {
                            if ($productCode == '') {
                                $bgColor = '#fcf8e3';
                            } else if ($productCode != $variant->product) {
                                if ($bgColor == '#f9f9f9') {
                                    $bgColor = '#fcf8e3';
                                } else {
                                    $bgColor = '#f9f9f9';
                            ...
                            echo "<td class='top-border right-border' align='left'>" . $variant->category_name . "</td>";
                            echo "<td class='top-border right-border' align='left'>" . $variant->product_name . "</td>";
                            if ($variant->variant_name == 'Default') {
                                echo "<td class='top-border right-border text-muted' align='left'><I>$variant->variant_name</I></td>";
                            } else {
                                echo "<td class='top-border right-border'  align='left'>$variant->variant_name</td>";
                            }
                            //echo "<td class='top-border right-border' align='left'>" . $stockOutDetail['variant_name'] . "</td>";
                            echo "<td class='top-border right-border' align='right'>" . number_format($variant->quantity, 2) . "</td>";
                            echo "<td class='top-border right-border' align='left'>" . $variant->unit_name . "</td>";
