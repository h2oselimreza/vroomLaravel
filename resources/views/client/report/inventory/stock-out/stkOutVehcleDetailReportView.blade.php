                ...
                <div id="" class="content-div">
                    ...
                    <table class="description" cellpadding="0" cellspacing="0" width="726">
                        ...
                        foreach ($stockOutDetails as $stockOutDetail) {
                            if ($stockOutDetail->vehicle != $vehicle) {
                                ...
                                echo "<tr>";
                                echo "<td class='top-border bottom-border vehicle-reg' colspan='5' align='center'><b>" . $vehicleName . "</b></td>";
                                echo "</tr>";
                                $vehicle = $stockOutDetail->vehicle;
                                $variantId = "";
                            }
//
                            if ($vehicle == $stockOutDetail->vehicle && $stockOutDetail->variant != $variantId) {
