                    ...
                    <table class="description" cellpadding="0" cellspacing="0" width="726">
                        ...
                        foreach ($stockOutDetails as $stockOutDetail) {
                            ...
                            if ($stockOutDetail->stock_date != $stockDate) {
                                //$registrationNo = $stockOutDetail['registration_no'];
                            ...
                            if ($stockDate == $stockOutDetail->stock_date && $stockOutDetail->vehicle != $vehicle) {
                                $vehicleName = "";
                                if ($stockOutDetail->brand_name) {
                                    $vehicleName = $stockOutDetail->registration_no . " <i>( " . $stockOutDetail->brand_name . " " . $stockOutDetail->brand_model_name . " )</i>";
                                }
                                echo "<tr>";
                                echo "<td class='top-border bottom-border-gray vehicle-reg' colspan='5' align='left'><b>" . $vehicleName . "</b></td>";
                                echo "</tr>";
                                $vehicle = $stockOutDetail->vehicle;
                            }
                            
                            if ($stockDate == $stockOutDetail->stock_date && $stockOutDetail->vehicle == $vehicle && $stockOutDetail->variant != $variantId) {
                                $quantity = $stockOutDetail->debit_quantity - $stockOutDetail->credit_quantity;
                                echo "<tr>";
                                echo "<td class='right-border-gray top-border-gray' align='left'>" . $stockOutDetail->category_name . "</td>";
                                echo "<td class='right-border-gray top-border-gray' align='left'>" . $stockOutDetail->product_name . "</td>";
                                echo "<td class='right-border-gray top-border-gray' align='left'>" . $stockOutDetail->variant_name . "</td>";
