                ...
                <div id="" class="content-div">
                    ...
                    <table class="description" cellpadding="0" cellspacing="0" width="726">
                        ...
                        foreach ($stockOutDetails as $stockOutDetail) {
                            if ($stockOutDetail->variant != $variantId) {
                                if ($subTotalFlag) {
                                    echo "<tr>";
                                    echo "<td class='top-border-gray right-border-gray' colspan='3' align='right'><b>Total</b></td>";
                                    echo "<td class='top-border-gray right-border-gray' align='right'><b>" . number_format($subTotal, 2) . "</b></td>";
                                    echo "<td class='top-border-gray right-border-gray' align='left'>".$unitName."</td>";
                                    echo "</tr>";
                                    $subTotal = 0;
                                    $subTotalFlag = 0;
                                    $unitName = "";
                                ...
                                echo "<tr>";
                                echo "<td class='top-border bottom-border vehicle-reg' colspan='5' align='center'><b>" . $variantName . "</b></td>";
                                echo "</tr>";
                                $variantId = $stockOutDetail->variant;
                                $vehicle = "";
                            }
                            if ($variantId == $stockOutDetail->variant && $stockOutDetail->vehicle != $vehicle) {
                                ...
                                $subTotal += $quantity;
                                $subTotalFlag = 1;
                                $unitName = $stockOutDetail->unit_name;
                            }
                        }
                        echo "<tr>";
                        echo "<td class='top-border-gray right-border-gray' colspan='3' align='right'><b>Total</b></td>";
                        echo "<td class='top-border-gray right-border-gray' align='right'><b>" . number_format($subTotal, 2) . "</b></td>";
                        echo "<td class='top-border-gray right-border' align='left'>".$unitName."</td>";
                        echo "</tr>";
                        ?>
