        ...
        <div class="full-page" >
            <div id="my-div" class="my-div">
                <style>
                    ...
                    .bottom-border-bold{border-bottom: 2px solid black;}
                    .top-border{border-top: 1px solid black;} 
                    .top-border-bold{border-top: 2px solid black;} 
                    .top-border-gray{border-top: 1px solid #ddd;}
                ...
                <div id="" class="content-div">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" align="center" width="726">
                        ...
                        <tr>
                            <td align="center" class="body-heading2">Vehicle and Product wise report</td>
                        </tr>
                        <tr>
                    ...
                    <table class="description" cellpadding="0" cellspacing="0" width="726">
                        <tr>
                            <th class="bottom-border right-border" width="176"><b>Registration No</b></th>
                            <th class="bottom-border right-border" width="200"><b>Brand</b></th>
                            <th class="bottom-border right-border" width="200"><b>Brand Model</b></th>
                            <th class="bottom-border right-border" width="50"><b>Quantity</b></th>
                            <th class="bottom-border" width="100"><b>Unit Name</b></th>
                        </tr>
                        <?php
                        $totalExpense = 0;
                        $vehicle = "";
                        ...
                        foreach ($stockOutDetails as $stockOutDetail) {
                            ...
                            if ($stockOutDetail->stock_date != $stockDate) {
                                echo "<tr style='background-color:#f9f9f9'>";
                                echo "<td class='top-border-bold bottom-border-bold vehicle-reg' colspan='5' align='center'><b>" . get_date_format1($stockOutDetail->stock_date) . "</b></td>";
                                echo "</tr>";
                                $stockDate = $stockOutDetail->stock_date;
                                $variantId = "";
                                $vehicle = "";
                            }
                            if ($stockDate == $stockOutDetail->stock_date && $stockOutDetail->variant != $variantId) {
                                $variantName = "";
                                $variantName = 'Category : ' . $stockOutDetail->category_name . " | Product : " . $stockOutDetail->product_name . " | Variant : " . $stockOutDetail->variant_name;
                                echo "<tr>";
                                echo "<td class='top-border bottom-border-gray vehicle-reg' colspan='5' align='left'><b>" . $variantName . "</b></td>";
                                echo "</tr>";
                                $variantId = $stockOutDetail->variant;
                                $vehicle = "";
                            }

                            if ($stockDate == $stockOutDetail->stock_date && $stockOutDetail->variant == $variantId && $stockOutDetail->vehicle != $vehicle) {
                                
                                $quantity = $stockOutDetail->debit_quantity - $stockOutDetail->credit_quantity;
                                echo "<tr>";
                                echo "<td class='right-border-gray top-border-gray' align='left'>" . $stockOutDetail->registration_no . "</td>";
                                echo "<td class='right-border-gray top-border-gray' align='left'>" . $stockOutDetail->brand_name . "</td>";
                                echo "<td class='right-border-gray top-border-gray' align='left'>" . $stockOutDetail->brand_model_name . "</td>";
                                echo "<td class='right-border-gray top-border-gray' align='right'>" . number_format($quantity, 2) . "</td>";
                                echo "<td class='top-border-gray' align='left'>" . $stockOutDetail->unit_name . "</td>";
                                echo "</tr>";
                                $vehicle = $stockOutDetail->vehicle;
                            }
                        }
                        ?>
                    </table>
