...
<div class="block-header">
    <h2>EXPENSE CATEGORY</h2><br>
    <div class="breadcrumb breadcrumb-bg-blue-grey">
        <li><a href="/client/Home"> Home</a></li>
        <li><a href="#"> Master Data</a></li>
        <li><a href="/client/MasterData/expense"> Expense</a></li>
        <li><a href="/client/MasterData/expenseCategoryShow"> Expense Category</a></li>
    </div>
</div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" >
                            <div class="col-md-2 col-sm-6 col-xs-12 custom-div-bottom">
                                <form action="{{ route('client.master-data.expense-category.index') }}" id="statusForm" method="get">
                                    <div class="form-group form-float" >
                                        <div class="form-line">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                            ...
                                                                            <select class="form-control"
                                                                                ...
                                                                                @foreach($categories as $categoryModal)
                                                                                    ...
                                                                                    @if($categoryModal->category_code != $category->parent_category)
                                                                                        ...
                                                                                        @if($categoryModal->category_code != $category->category_code)

                                                                                            @php
                                                                                                $parentCategoryStr = get_parent_category_str([
                                                                                                    'parentCategoryCodeStr' => $categoryModal->parent_category_str,
                                                                                                    'categoryArr' => $allCategories
                                                                                                ]);

                                                                                                $parentCategoryArr = explode(' / ', $parentCategoryStr);
                                                                                            @endphp

                                                                                            @if(!in_array($category->category_name, $parentCategoryArr))
                                                                    ...
                                                                    <div class="form-group form-float">
                                                                        ...
                                                                        <label id="catNameReq-error{{ $count }}"
                                                                            class="error hidden">
...
<script>
    function submitAddCategory() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ route('client.master-data.expense-category.store') }}",
            data: {
                ...inputFiledJsonData,
                _token: "{{ csrf_token() }}"
            },
    ...
    function updateInfo(serial) {
        ...
        $.ajax({
            type: 'PUT',
            url: "{{ route('client.master-data.expense-category.update', ':id') }}"
            .replace(':id', 1),
            data: {
                ...inputFiledJsonData,
                serial: serial,
    ...
    function removeCategory(categoryId) {
        ...
        swal({
            ...
            $.ajax({
                ...
                url: "{{ route('client.master-data.expense-category.destroy', ':id') }}"
    ...
    function activeCategory(categoryId) {
        ...
        swal({
            ...
            $.ajax({
                ...
                url: "{{ route('client.master-data.expense-category.active') }}",
