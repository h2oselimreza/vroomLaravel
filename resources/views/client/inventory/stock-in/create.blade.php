...
<div class="block-header">
    ...
    <div class="breadcrumb breadcrumb-bg-blue-grey">
        ...
        <li><a href="{{ route('client.inventory.stock-in.create') }}"> New Stock In</a></li>
    </div>
</div>
            ...
            <div class="body">
                ...
                <div class="panel panel-default"> 
                    <div class="panel-body">
                        <form action="{{ route('client.inventory.stock-in.store') }}" method="post" id="stockInForm">
                            @csrf
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group form-float" >
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="title" max="100" id="title">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group form-float" >
                                        <div class="form-line">
                                            <input type="text" class="form-control dateInput" name="sockInDate" id="sockInDate" value="<?php echo date('Y-m-d') ?>">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group form-float" >
                                        <div class="form-line">
                                            <input type="text" class="form-control" max="100" name="referenceNo" id="referenceNo">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="table-custom-responsive">
                                        ...
                                        <input type="hidden" name="counterHidden" id="counterHidden"> <!-- total variant count -->
                                    </div>
                                    <div class="text-right">
                                        <button type="button" class="btn bg-blue btn-xs waves-effect" onclick="addNewRowStock()" >Add Product Variant</button>
                                    </div>
                                    <div class="text-left">
                                        <button type="button" type="button" class="btn bg-blue waves-effect" onclick="addStockIn()" >Save New Stock</button>
                                    </div>
