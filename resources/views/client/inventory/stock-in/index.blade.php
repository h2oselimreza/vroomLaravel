                    ...
                    <div class="panel-body">
                        <div class="row" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <a href="{{ route('client.inventory.stock-in.create') }}" class="btn btn-primary bg-blue btn-sm waves-effect">New Stock</a>
                            </div>
                        </div>
                                                        ...
                                                        <td class="td-center">
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu pull-right">
                                                                    ...
                                                                    <li>
                                                                        <a href="{{ route('client.inventory.stock-in.edit',$stock->stock_summary_id) }}">
                                                                            Edit
                                                                        </a>
                                                                    </li>
...
<script>
    function removeStockSummary(stockSummaryId) {
        ...
        swal({
            title: "Are you sure?",
            text: "If you remove this main stock will decrease...!",
            type: "warning",
            ...
            $.ajax({
                url: "{{ route('client.inventory.stock-in.destroy',1) }}",
                type: "DELETE",
                data: {
            ...
            .done(function (data) {
                ...
                if (data === '1') {
                    ...
                    swal({
                        ...
                        text: "This stock In is removed now",
                        type: "success",
                        closeOnConfirm: false,
