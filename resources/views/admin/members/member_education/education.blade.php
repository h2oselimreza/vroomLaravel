    ...
    <div class="card-body">
      ...
      <div class="tab-content" id="memberTabContent">
        <div class="tab-pane fade show active" id="official" role="tabpanel">
            <form action="{{ route('admin.member.module.education.update',$data->id) }}" method="POST">
             @csrf 
             <div class="panel-group">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12 accordion-header">
                      <h4 class="panel-title accordion-button">
