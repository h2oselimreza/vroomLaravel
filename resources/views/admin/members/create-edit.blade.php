        ...
        <div class="card-body">
            ...
            <div class="tab-content" id="employeeTabContent">
                ...
                <div class="tab-pane fade show active"
                    ...
                    @endphp
                    <form action="{{ $isEdit 
                        ? route('admin.member.module.update', $data->id) 
                        : route('admin.member.module.store') }}"
                        method="POST">
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text"
                                                    name="member_name"
                                                    value="{{ old('member_name', $data->member_name ?? '') }}"
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label">Full Name (In Bangla)</label>
                                                <input type="text"
                                                    name="member_bangla_name"
                                                    value="{{ old('member_bangla_name', $data->member_bangla_name ?? '') }}"
                                                    placeholder="Enter full name"
                                                    class="form-control @error('member_bangla_name') is-invalid @enderror">

                                                @error('member_bangla_name')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-control" name="member_occupation">
                                                    ...
                                                    <option value="singer_artist">Singer/Artist</option>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('institution_name', $data->institution_name ?? '') }}"
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select 
                                                    name="society_road" 
                                                    id="road" 
                                                    class="form-control @error('society_road') is-invalid @enderror">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input 
                                                    type="text" 
                                                    name="society_plot"
                                                    value="{{ old('society_plot', $data->society_plot ?? '') }}"
                                                    placeholder="Enter Plot"
                                                    class="form-control @error('society_plot') is-invalid @enderror">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input 
                                                    type="text" 
                                                    name="society_flat"
                                                    value="{{ old('society_flat', $data->society_flat ?? '') }}"
                                                    placeholder="Enter flat"
                                                    class="form-control @error('society_flat') is-invalid @enderror">
                                ...
                                <div id="contactInfo"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            {{-- Secondary Mobile --}}
                                            <div class="col-md-6">
                                                <label class="form-label">Secendary Mobile</label>
                                                <input type="text"
                                                    name="secendary_mobile"
                                                    value="{{ old('secendary_mobile', $data->secendary_mobile ?? '') }}"
                                                    placeholder="Enter secendary mobile number"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text"
                                                    name="member_tnt_phone"
                                                    value="{{ old('member_tnt_phone', $data->member_tnt_phone ?? '') }}"
                                                    placeholder="Enter land phone number"
                                                    class="form-control @error('member_tnt_phone') is-invalid @enderror">

                                                @error('member_tnt_phone')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('member_permanent_address', $data->member_permanent_address ?? '') }}"
                                                    placeholder="Enter permanent address"
                                                    class="form-control @error('member_permanent_address') is-invalid @enderror">

                                                @error('member_permanent_address')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
...
<script>
    ...
    const data   = @json($blockRoads);
    const $block = $('#block');
    const $road  = $('#road');

    // Values from backend
    const selectedBlockValue = "{{ old('block', $data->society_block ?? '') }}";
    const selectedRoadValue  = "{{ old('road', $data->society_road ?? '') }}";
    ...
    $block.on('change', function () {
        ...
        // Filter roads by selected block
        let roads = data.filter(function(item) {
        ...
        // ---- Set selected road only on first load ----
        if (firstLoad && selectedRoadValue && selectedBlockValue === selectedBlock) {
            $road.val(selectedRoadValue);
            firstLoad = false;
        }
    ...
    if (selectedBlockValue) {
        $block.val(selectedBlockValue).trigger('change');
    }
    });
</script>
@endpush
