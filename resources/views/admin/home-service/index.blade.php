            ...
            <div class="panel panel-default">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover custom-table" id="datatable">
                        ...
                        <tbody>
                            @forelse($data as $index => $appointment)
                                <tr>
                                    ...
                                    <td class="td-center">
                                        {{ get_account_type_name($appointment->company_type ?? null) }}
                                    </td>

                                    <td class="td-center">
                                        {{ !empty($appointment->final_date) ? get_date_format1($appointment->final_date) : '' }}
                                    </td>

                                    <td class="td-center">
                                        {{ !empty($appointment->appointment_time) ? get_time_format($appointment->appointment_time) : '' }}
                                    </td>

                                    <td class="td-center">
                                        {{ get_appointment_status($appointment->status ?? null, 'client') }}
                                    </td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    ...
                                                    href="{{ route('admin.home-service.details', [$appointment->appointment_no, $appointment->company]) }}">
                                                        Show
                                                    </a>
                                                </li>
                                            </ul>
