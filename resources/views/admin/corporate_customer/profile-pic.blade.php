...
<div class="header dashboard_from">
    <h1 class="page-title">
        {{ isset($data->exists) ? 'Edit Profile Image' : 'Add Company' }}
    </h1>
</div>
<div class="container">
        ...
        <div class="card-body">
            ...
            <div class="tab-content" id="employeeTabContent">
                ...
                <div class="tab-pane fade show active"
                    id="official"
                    role="tabpanel">
                    <form action="{{ route('admin.company.profile-image.update',$data->company_code) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                            ...
                                            <div class="col-md-4">
                                                <div class="d-flex flex-column align-items-center text-center">
                                                    ...
                                                    @if($data->profile_image)
                                                        <img border="1"
                                                            id="blah"
                                                            src="{{ asset('storage/company/' . $data->profile_image) }}"
