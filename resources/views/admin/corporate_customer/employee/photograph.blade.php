        ...
        <div class="card-body">
            ...
            <div class="tab-content" id="employeeTabContent">
                ...
                <div class="tab-pane fade show active"
                    id="official"
                    role="tabpanel">
                    <form action="{{ route('admin.customer-employee.photo.update',$data->employee_id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                            ...
                                            <div class="col-md-4">
                                                <div class="d-flex flex-column align-items-center text-center">
                                                    ...
                                                    @if($data->employee_image)
                                                        <img border="1"
                                                            id="blah"
                                                            src="{{ asset('assets/images/employee/' . $data->employee_image) }}"
