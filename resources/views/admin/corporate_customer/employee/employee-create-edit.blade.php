                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="guardian_relation"
                                                    ...
                                                    @foreach(['daughter'=>'Daughter','grandFather'=>'Grand Father','grandMother'=>'Grand Mother','son'=>'son'] as $key=>$guardian_relation)
                                                        <option value="{{ $key }}"
                                                            {{ old('guardian_relation', $data->guardian_relation ?? '')==$guardian_relation?'selected':'' }}>
                                                            {{ $guardian_relation }}
                                                        </option>
                                                    @endforeach
                                                </select>	
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="form-label">Relationship</label>
                                                        <select name="emer_contact_relation"
                                                            class="form-select @error('emer_contact_relation') is-invalid @enderror">
                                                            <option value="">Select Relation</option>
                                                            @foreach(['daughter'=>'Daughter','grandFather'=>'Grand Father','grandMother'=>'Grand Mother','son'=>'son'] as $key=>$guardian_relation)
                                                                <option value="{{ $key }}"
                                                                    {{ old('emer_contact_relation', $data->emer_contact_relation ?? '')==$guardian_relation?'selected':'' }}>
                                                                    {{ $guardian_relation }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        class="form-control @error('ref_one_name') is-invalid @enderror"
                                                        name="ref_one_name"
                                                        value="{{ old('ref_one_name', $data->ref_one_name ?? '') }}"
                                                        placeholder="Enter ref one name">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        class="form-control @error('ref_one_mobile') is-invalid @enderror"
                                                        name="ref_one_mobile"
                                                        id="ref_one_mobile"
                                                        value="{{ old('ref_one_mobile', $data->ref_one_mobile ?? '') }}"
                                                        placeholder="Enter mobile number"
                                                        onchange="checkMobileNumber(this.value, 'ref_one_mobile')">

                                                    @error('ref_one_mobile')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>	
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="form-label">Email</label>
                                                    <input type="text"
                                                        class="form-control @error('ref_one_email') is-invalid @enderror"
                                                        name="ref_one_email"
                                                        value="{{ old('ref_one_email', $data->ref_one_email ?? '') }}"
                                                        placeholder="Enter ref one email">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="form-label">Address</label>
                                                    <input type="text"
                                                        class="form-control @error('ref_one_address') is-invalid @enderror"
                                                        name="ref_one_address"
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        class="form-control @error('ref_two_name') is-invalid @enderror"
                                                        name="ref_two_name"
                                                        value="{{ old('ref_two_name', $data->ref_two_name ?? '') }}"
                                                        placeholder="Enter ref two name">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="form-label">Mobile No</label>
                                                    <input type="text"
                                                        class="form-control @error('ref_two_mobile') is-invalid @enderror"
                                                        name="ref_two_mobile"
                                                        id="ref_two_mobile"
                                                        value="{{ old('ref_two_mobile', $data->ref_two_mobile ?? '') }}"
                                                        placeholder="Enter mobile number"
                                                        onchange="checkMobileNumber(this.value, 'ref_two_mobile')">

                                                    @error('ref_two_mobile')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>	
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="form-label">Email</label>
                                                    <input type="text"
                                                        class="form-control @error('ref_two_email') is-invalid @enderror"
                                                        name="ref_two_email"
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="form-label">Email</label>
                                                    <input type="text"
                                                        class="form-control @error('ref_two_address') is-invalid @enderror"
                                                        name="ref_two_address"
