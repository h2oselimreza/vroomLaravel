            ...
            <div class="panel panel-default" style="padding: 20px;">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="{{ route('admin.customer-employee.attachment.store') }}" 
                            ...
                            <table class="table table-bordered table-hover custom-table" id="datatable">
                                ...
                                <tbody>
                                    @forelse ($albumImages as $value)
                                        @php
                                            $filePath = asset('assets/files/employee/' . $value->file_name);
                                        ...
                                        <tr>
                                            ...
                                            {{-- ✅ DELETE --}}
                                            <td class="text-center">
                                                <form action="{{ route('admin.customer-employee.attachment.destory', $value->employee) }}" 
                                                    method="POST"
