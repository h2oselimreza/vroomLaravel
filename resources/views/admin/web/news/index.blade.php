...
<div class="main-content">
    ...
    <div class="add-button">
        <a href="{{ route('admin.news.module.create') }}">Add Latest News</a>
    </div>
    <div class="row">
...
<script>
    ...
    $('#datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.news.data.index') }}",
        columns: [
            ...
            {data: 'publish_date', name: 'publish_date', orderable:true, searchable:true},
