...
<div class="main-content">
    ...
    <div class="add-button">
        <a href="{{ route('admin.notices.module.create') }}">Add Notices</a>
    </div>
...
<script>
    ...
    $('#datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.notices.data.index') }}",
        columns: [
            {data: 'heading', name: 'heading', orderable:true, searchable:true},
            {data: 'body', name: 'body', orderable:true, searchable:true},
            {data: 'is_active', name: 'is_active', orderable:true, searchable:true, className: 'text-center'},
            {data: 'publish_date', name: 'publish_date', orderable:true, searchable:true, className: 'text-center'},
