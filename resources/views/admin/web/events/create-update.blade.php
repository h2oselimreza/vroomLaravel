...
<div class="header dashboard_from">
    <h1 class="page-title">
        {{ isset($data->exists) ? 'Edit Events' : 'Add Events' }}
    </h1>
    <ul class="breadcrumb">
        <li><a href="#"> Home</a></li>
...
<div class="main-content">
    <div class="card from_card">
        <div class="card-header">
            {{ isset($data->exists) ? 'Update Events' : 'Create Events' }}
        </div>
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal"
              action="{{ isset($data->exists) 
                    ? route('admin.events.module.update', $data->id) 
                    : route('admin.events.module.store') }}"
              method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        @if(isset($data) && $data->image)
                            <div class="mb-2">
                                <img src="{{ asset('images/events/' . $data->image) }}" alt="image" width="200" height="150">
                            </div>
                        @endif
                ...
                <div class="ps-0 card-footer bg-white d-flex gap-2">
                    ...
                    <a href="{{ route('admin.events.module.index') }}"
