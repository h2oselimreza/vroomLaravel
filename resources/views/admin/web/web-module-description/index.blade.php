...
<div class="header dashboard_from">
    <h1 class="page-title">Website Module Description</h1>
    <ul class="breadcrumb">
        <li><a href="#"> Home</a></li>
...
<div class="main-content">
    ...
    <div class="add-button">
        <a href="{{ route('admin.module-description.module.create') }}">Add Website Module Description</a>
    </div>
                     ...
                     <table class="table table-bordered table-hover custom-table" id="datatable">
                        <thead>
                            <tr class="bg-primary">
                                ...
                                <th>Image for Short Description</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tfoot>
...
<script>
    ...
    $('#datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.module-description.data.index') }}",
        columns: [
            {data: 'module_code', name: 'module_code', orderable:false, searchable:false},
            {data: 'heading', name: 'heading', orderable:true, searchable:true},
