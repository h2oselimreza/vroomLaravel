...
<div class="header dashboard_from">
    <h1 class="page-title">Website Module</h1>
    <ul class="breadcrumb">
        <li><a href="#"> Home</a></li>
        <li><a href="#">/ Website Configuration</a></li>
        <li><a href="#">/ Website Module</a></li>
    </ul>
</div>
...
<script>
    ...
    $('#datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.website.data.index') }}",
        columns: [
            {data: 'module_code', name: 'module_code', orderable:false, searchable:false},
            {data: 'web_module_name', name: 'web_module_name', orderable:true, searchable:true},
