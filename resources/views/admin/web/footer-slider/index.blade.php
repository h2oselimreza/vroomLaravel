...
<div class="header dashboard_from">
    <h1 class="page-title">Footer Slider Image</h1>
    <ul class="breadcrumb">
        <li><a href="#"> Home</a></li>
        <li><a href="#">/ Website Configuration</a></li>
        <li><a href="#">/ Footer Slider Image</a></li>
    </ul>
</div>
<div class="main-content">
    ...
    <div class="add-button">
        <a href="{{ route('admin.footer-slider.module.create') }}">Add Footer Slider</a>
    </div>
    <div class="row">
...
<script>
    ...
    $('#datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.footer-slider.data.index') }}",
        columns: [
            {data: 'image', name: 'image', orderable:false, searchable:false},
            {data: 'image_order', name: 'image_order', orderable:true, searchable:true, className: 'text-center'},
