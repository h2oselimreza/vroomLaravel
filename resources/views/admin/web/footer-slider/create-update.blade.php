...
<div class="header dashboard_from">
    <h1 class="page-title">
        {{ isset($data->exists) ? 'Edit Footer Slider' : 'Add Footer Slider' }}
    </h1>
    <ul class="breadcrumb">
        <li><a href="#"> Home</a></li>
...
<div class="main-content">
    <div class="card from_card">
        <div class="card-header">
            {{ isset($data->exists) ? 'Update Footer Slider' : 'Create Footer Slider' }}
        </div>
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal"
              action="{{ isset($data->exists) 
                    ? route('admin.footer-slider.module.update', $data->id) 
                    : route('admin.footer-slider.module.store') }}"
