...
<div class="header dashboard_from">
    <h1 class="page-title">Gallery Image</h1>
    <ul class="breadcrumb">
        <li><a href="#"> Home</a></li>
...
<div class="main-content">
    ...
    <div class="add-button">
        <a href="{{ route('admin.gallery-image.module.create') }}">Add Gallery Image</a>
    </div>
    <div class="row">
...
<script>
    ...
    $('#datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.gallery-image.data.index') }}",
        columns: [
            { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false, className: 'text-center'},
            {data: 'album_name', name: 'album_name', orderable:false, searchable:false, className: 'text-center'},
            {data: 'image', name: 'image', orderable:true, searchable:true, className: 'text-center'},
