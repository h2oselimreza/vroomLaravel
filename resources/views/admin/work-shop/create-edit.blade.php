...
<div class="header dashboard_from">
    <h1 class="page-title">
        {{ isset($data->exists) ? 'Edit Workshop' : 'Add Workshop' }}
    </h1>
</div>
                                ...
                                <div id="personalInfo"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="row g-3">
                                            {{-- Full Name --}}
                                            <div class="col-md-6">
                                                <label class="form-label">Workshop Title/Name <span>*</span></label>
                                                <input type="text"
                                                    name="title"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text"
                                                    name="workshop_email"
                                                    value="{{ old('workshop_email', $data->workshop_email ?? '') }}"
                                                    placeholder="Email"
                                                    class="form-control @error('workshop_email') is-invalid @enderror">

                                                @error('workshop_email')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text"
                                                    name="workshop_mobile"
                                                    value="{{ old('workshop_mobile', $data->workshop_mobile ?? '') }}"
                                                    placeholder="Mobile"
                                                    class="form-control @error('workshop_mobile') is-invalid @enderror">

                                                @error('workshop_mobile')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text"
                                                    name="workshop_land_phone"
                                                    value="{{ old('workshop_land_phone', $data->workshop_land_phone ?? '') }}"
                                                    placeholder="Mobile"
                                                    class="form-control @error('workshop_land_phone') is-invalid @enderror">

                                                @error('workshop_land_phone')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            {{-- Division --}}
