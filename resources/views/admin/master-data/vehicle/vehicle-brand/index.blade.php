        ...
        <div class="col-sm-12 col-md-12">
            ...
            <div class="panel panel-default"> 
                <div class="add-button">
                    <a href="{{ route('admin.modules.master-data.vehicle-brand.create') }}">Add Vehicle Brand</a>
                </div>
                            ...
                            @forelse ($data as $value)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.modules.master-data.vehicle-brand.show',$value->id) }}" 
                                        ...
                                        <a href="{{ route('admin.modules.master-data.vehicle-brand.edit',$value->id) }}" 
                                        class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary action_button_modify">
