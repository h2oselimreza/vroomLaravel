...
<div class="header dashboard_from">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="{{ url('admin/MasterData/area') }}">/ Vehicle Brand</a></li>
    </ul>
</div>
...
<div class="main-content">
    <div class="card from_card">
        ...
        <div class="card-body" x-data="vehicleForm()">
            <form 
                action="{{ isset($data->exists) ? route('admin.modules.master-data.vehicle-brand.update', $data->id) : route('admin.modules.master-data.vehicle-brand.store') }}"
                method="POST"
            ...
            >
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Vehicle Brand : <span>*</span></label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Vehicle Brand Order :</label>
                ...
                <div class="ps-0 card-footer bg-white d-flex gap-2">
                    ...
                    <a href="{{ route('admin.modules.master-data.vehicle-brand.index') }}" class="btn btn-outline-secondary">
                        Cancel
                    </a>
                </div>
            </form>
