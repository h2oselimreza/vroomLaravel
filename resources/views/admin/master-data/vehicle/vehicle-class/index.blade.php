...
<div class="header dashboard_from">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="{{ url('admin/MasterData/area') }}">/ Vehicle Class</a></li>
    </ul>
</div>
        ...
        <div class="col-sm-12 col-md-12">
            ...
            <div class="panel panel-default"> 
                <div class="add-button">
                    <a href="{{ route('admin.modules.master-data.vehicle-class.create') }}">Add Vehicle Class</a>
                </div>
                    ...
                    <table class="table table-bordered table-hover custom-table vehicle-table" id="datatable">
                        ...
                        <tbody>
                            @forelse ($data as $value)
                                <tr>
                                    <td>{{ $value->element }}</td>
                                    <td>{{ $value->element_bn }}</td>
                                    <td>{{ ($value->is_active) ? 'Active':'Inactive' }}</td>
                                    <td>{{ $value->element_order }}</td>
                                    <td class="text-center">
                                        <a href="{{ route('admin.modules.master-data.vehicle-class.show',$value->id) }}" 
                                        ...
                                        <a href="{{ route('admin.modules.master-data.vehicle-class.edit',$value->id) }}" 
                                        class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary action_button_modify">
