...
<div class="main-content">
    <div class="card from_card">
        ...
        <div class="card-body" x-data="vehicleForm()">
            <form 
                action="{{ isset($data->exists) ? route('admin.modules.master-data.vehicle-color.update', $data->id) : route('admin.modules.master-data.vehicle-color.store') }}"
                method="POST"
            ...
            >
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Vehicle Color : <span>*</span></label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Vehicle Color Order :</label>
