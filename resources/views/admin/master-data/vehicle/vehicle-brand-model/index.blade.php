        ...
        <div class="col-sm-12 col-md-12">
            ...
            <div class="panel panel-default"> 
                <div class="add-button">
                    <a href="{{ route('admin.modules.master-data.vehicle-brand-model.create') }}">Add Vehicle Brand Model</a>
                </div>
                    ...
                    <table class="table table-bordered table-hover custom-table vehicle-table" id="datatable">
                        <thead>
                            <tr class="bg-primary">
                                ...
                                <th>Active</th>
                                <th>Vehicle Brand Model Order</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                            ...
                            @forelse ($data as $value)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.modules.master-data.vehicle-brand-model.show',$value->id) }}" 
                                        ...
                                        <a href="{{ route('admin.modules.master-data.vehicle-brand-model.edit',$value->id) }}" 
                                        class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary action_button_modify">
