        ...
        <div class="col-sm-12 col-md-12">
            ...
            <div class="panel panel-default"> 
                <div class="add-button">
                    <a href="{{ route('admin.modules.master-data.vehicle-condition.create') }}">Add Vehicle Condition</a>
                </div>
                            ...
                            @forelse ($data as $value)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.modules.master-data.vehicle-condition.show',$value->id) }}" 
                                        ...
                                        <a href="{{ route('admin.modules.master-data.vehicle-condition.edit',$value->id) }}" 
                                        class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary action_button_modify">
