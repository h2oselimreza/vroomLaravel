...
<div class="header dashboard_from">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="{{ url('admin/master-data/call-reason') }}">/ Call Reason</a></li>
    </ul>
</div>
...
<div class="main-content">
    <div class="card from_card">
        ...
        <div class="card-body" x-data="vehicleForm()">
            <form 
                action="{{ isset($data->exists) ? route('admin.module.master-data.call-reason.update', $data->reason_code) : route('admin.module.master-data.call-reason.store') }}"
                method="POST"
            ...
            >
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Reason Order :</label>
                        <input type="number" name="reason_order" class="form-control"
                            x-model="formData.reason_order"
                            placeholder="Enter order"
                            value="{{ old('reason_order', $data->reason_order ?? '') }}">
                        @error('reason_order')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
