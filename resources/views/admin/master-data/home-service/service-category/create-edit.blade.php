...
<div class="main-content">
    <div class="card from_card">
        ...
        <div class="card-body" x-data="vehicleForm()">
            <form 
                action="{{ isset($data->exists) ? route('admin.modules.master-data.home-service-category.update', $data->category_code) : route('admin.modules.master-data.home-service-category.store') }}"
                method="POST"
            ...
            >
                ...
                <div class="ps-0 card-footer bg-white d-flex gap-2">
                    ...
                    <a href="{{ route('admin.modules.master-data.home-service-category.index') }}" class="btn btn-outline-secondary">
                        Cancel
                    </a>
                </div>
            </form>
