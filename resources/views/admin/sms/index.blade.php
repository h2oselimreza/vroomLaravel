...
<div class="header dashboard_from">
    <h1 class="page-title">Member Bithday SMS</h1>
    <ul class="breadcrumb">
        <li><a href="#"> Home</a></li>
        <li><a href="#">/ SMS</a></li>
        <li><a href="#">/ Member Bithday SMS</a></li>
    </ul>
</div>
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel panel-default"> 
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <form action="{{ route('admin.member-birthday-sms-send',1) }}" method="post" class="me-2">
                        @csrf
...
<script>
    ...
    table = $('#datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.member-birthday-sms-data.data.index') }}",
        columns: [
