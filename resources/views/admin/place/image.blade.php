                        ...
                        <div class="accordion-item">
                            ...
                            <div id="personalInfo"
                                ...
                                <div class="accordion-body">
                                    <form action="{{ route('admin.place.place-image.update',$data->place_code) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="d-flex flex-column align-items-center text-center">
                                                    ...
                                                    @if($data->profile_image)
                                                        <img border="1"
                                                            id="blah"
                                                            src="{{ asset('assets/images/place/' . $data->profile_image) }}"
                                            ...
                                            <div class="panel panel-default" style="padding: 20px;">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <form action="{{ route('admin.place.place-image.store') }}" 
                                                                ...
                                                                <tbody>
                                                                    @if ($files)
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            {{-- ✅ DELETE --}}
                                                                            <td class="text-center">
                                                                                <form action="{{ route('admin.place.place-image.destroy', $value->id) }}" 
                                                                                    method="POST"
