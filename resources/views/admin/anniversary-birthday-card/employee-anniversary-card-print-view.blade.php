                    ...
                    <div id="" class="content-div">
                        ...
                        <div class="card">
                            ...
                            <div class="couple-name">
                                {{ $personalInformation->employee_name }} & {{ $personalInformation->spouse_name }}
                            </div>
                            <div class="message">
                                Wishing you both a lifetime of love, happiness, and togetherness.
                                <br><br>
                                May your bond grow stronger with each passing year. Cheers to your beautiful journey together! 💑
                            </div>
